...
private:
  ...
  constexpr void _Get(T&& func, MyTF::ArgsPack<TArgs...> pack, TS&& ...args) requires(std::is_invocable_v<T, TArgs...>) {
...
public:
  ...
  constexpr void Get2(T v, TArgs ...args)requires ((std::is_same_v<T, int64_t*> || std::is_same_v<T, std::string*>)) {
